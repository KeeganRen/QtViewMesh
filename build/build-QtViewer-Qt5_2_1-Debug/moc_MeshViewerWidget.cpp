...
#include "../../include/MeshViewerWidget.hh"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MeshViewerWidget_t, stringdata) + ofs \
...
const QMetaObject MeshViewerWidget::staticMetaObject = {
    { &MeshViewerWidgetT<MyMesh>::staticMetaObject, qt_meta_stringdata_MeshViewerWidget.data,
      qt_meta_data_MeshViewerWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MeshViewerWidget.stringdata))
