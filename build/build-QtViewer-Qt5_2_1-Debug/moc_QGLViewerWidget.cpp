...
#include "../../include/QGLViewerWidget.hh"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QGLViewerWidget_t, stringdata) + ofs \
...
const QMetaObject QGLViewerWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_QGLViewerWidget.data,
      qt_meta_data_QGLViewerWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGLViewerWidget.stringdata))
